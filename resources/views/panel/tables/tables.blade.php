...
@foreach ($tables as $table)
  <tr>
    <td class="align-content-center">{{ $table->title }}</td>
      <td class="align-content-center">{{ $table->seats }}</td>
      <td class="align-content-center">
      <form action="{{ route('tables.delete', $table->id) }}" method="POST" style="display: inline;">
            @csrf
            @method('DELETE')
