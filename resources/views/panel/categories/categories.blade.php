...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="get" action="{{route('categories.search')}}">
  ...
  <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <li class="nav-item">
              <a class="nav-link collapsed" href="{{route('tables.index')}}">
                  <i class="bi bi-question-circle"></i>
                  <span>Tables</span>
              </a>
          </li>
              ...
              <div class="modal fade" id="basicModal" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    @endif
                    @csrf  <!-- laravel can't read the post without this -->
                    <div class="mb-3">
...
@foreach ($categories as $category)
  <tr>
    ...
    <td ><img src="{{ asset('storage/' . $category->image) }}" alt="Product Image" width="200"></td>
    <td class="align-content-center"><a href="{{ route('categories.edit', $category->id) }}">
      <button class="border-0" style="color: green">Edit</button>
        </a>
